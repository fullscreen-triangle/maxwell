...
\title{\textbf{Partition-Based Equations of State for Cellular Systems}}
...
\input{sections/transport-phenomena}
\input{sections/ternary-encoding}
\input{sections/poincare-computing}
\input{sections/metabolic-sequential-positioning}
\input{sections/phase-lock-networks}
\input{sections/aperture-dynamics}
\input{sections/substrate-navigation}
\input{sections/protein-folding-dynamics}
\input{sections/membrane-transport-demons}
\input{sections/categorical-thermometry}

\section{Discussion}
\label{sec:discussion}

The partition-based framework derives cellular state equations from geometric necessity in bounded phase space. Experimental validation across multiple platforms confirms theoretical predictions without adjustable parameters.
...
We have derived complete equations of state for cellular systems from two axioms: bounded phase space and categorical observation. The principal results are:

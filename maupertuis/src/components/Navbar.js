  ...
  return (
    ...
    ">
      ...
      <nav className="flex items-center justify-center">
        ...
        <CustomLink className="mx-4" href="/gas" title="Gas Dynamics" />
        <CustomLink className="mx-4" href="/fluids" title="Fluid Dynamics" />
        <CustomLink className="mx-4" href="/about" title="About" />
        <CustomLink className="ml-4" href="/simulate" title="Simulator" />
      </nav>
      <nav
      ...
      </div>
    {
      ...
      <nav className="flex items-center justify-center flex-col">
        ...
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/gas" title="Gas Dynamics" />
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/fluids" title="Fluid Dynamics" />
        <CustomMobileLink toggle={handleClick} className="mx-4 lg:m-0 lg:my-2" href="/about" title="About" />
        <CustomMobileLink toggle={handleClick} className="ml-4 lg:m-0 lg:my-2" href="/simulate" title="Simulator" />
      </nav>
      <nav

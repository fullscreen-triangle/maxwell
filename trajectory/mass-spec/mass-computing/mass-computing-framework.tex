...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{mass_computing_s_entropy.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{mass_computing_validation.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{mass_computing_physics.png}
\caption{Physics-based observable extraction. (A) Cyclotron frequency vs m/z relationship, following $\omega_c = qB/m$. (B) Constant trap volume reflecting uniform phase space partitioning. (C) Intensity to S-entropy mapping demonstrating bijective transformation. (D) Summary statistics confirming framework validation on 708 scans with 100\% partition coordinate validity.}
\label{fig:real_physics}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{circular_validation_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{cv_validation_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{hierarchical_validation_panel.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{combined_validation_summary.png}
...
\begin{itemize}
\item \textbf{Python}: Rapid prototyping, validation, visualization using NumPy~\cite{harris2020array} and Matplotlib~\cite{hunter2007matplotlib}
\item \textbf{Rust}: Production performance, memory safety, concurrency~\cite{rust2021rust}
\end{itemize}
...
\item \textbf{Parallelism}: Rayon-based~\cite{rayon2020} parallel extraction for batch processing
\end{enumerate}

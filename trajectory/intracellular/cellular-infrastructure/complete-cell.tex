...
\section{Ideal Gas Laws from Triple Equivalence}
\import{sections/}{ideal-gas-laws.tex}
...
\begin{itemize}
\item \textbf{Atomic systems:} Partition coordinates $(n,\ell,m,s)$ generate periodic table with capacity $2n^2$ through quantum number constraints \citep{tolman1938principles}
\item \textbf{Ideal gases:} Triple equivalence yields $PV = Nk_BT$ from oscillatory, categorical, and partition formulations \citep{gibbs1902elementary, huang1987statistical}
\item \textbf{Kinetic theory:} Maxwell-Boltzmann distribution emerges from categorical continuum limit with natural relativistic cutoff \citep{maxwell1860illustrations, boltzmann1872weitere}
\item \textbf{Fluctuation theorems:} Jarzynski equality and Crooks relation follow from trajectory-level entropy production \citep{jarzynski1997nonequilibrium, crooks1999entropy}
\item \textbf{Information-energy equivalence:} Landauer's principle connects categorical erasure to minimum energy dissipation \citep{landauer1961irreversibility, bennett1982thermodynamics}

...
\subsection{Spectral Instantiation of Fluid Elements}
...
\subsection{Light from Partition Operations}
\label{part:light}
...
\subsection{Fluid Dynamics from Partition Networks}
\label{part:fluid}
...
\subsection{Ray-Marched Fluid Observation}
...
\subsection{GPU Shader Pipeline for Fluid Dynamics}
\label{part:pipeline}

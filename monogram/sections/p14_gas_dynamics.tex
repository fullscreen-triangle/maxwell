...
\subsection{Spectral Instantiation of Gas Particles}
...
\subsection{Gas Dynamics from Spectral Interference}
...
\subsection{Ray-Marched Gas Observation}
...
\subsection{GPU Shader Pipeline for Gas Dynamics}
\label{part:pipeline}

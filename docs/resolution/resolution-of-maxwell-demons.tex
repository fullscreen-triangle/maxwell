...
\input{sections/categorical-completion}
\input{sections/virtual-gas-ensemble}
\input{sections/categorical-selection}
\input{sections/temperature-emergence}
\input{sections/entropy-mechanism}
\input{sections/le-chatelier-connection}
\input{sections/heat-transfer}
\input{sections/velocity-temperature-overlap}
\input{sections/velocity-entropy-independence}

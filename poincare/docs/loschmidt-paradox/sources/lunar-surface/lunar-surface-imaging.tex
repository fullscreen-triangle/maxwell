...
\input{sections/oscillatory-dynamics}
\input{sections/categorical-dynamics}
\input{sections/geometric-partitioning}
\input{sections/spatio-temporal-coordinates}
\input{sections/massive-body-dynamics}
\input{sections/representations-of-the-moon}
\input{sections/high-resolution-interferometry}
\input{sections/lunar-surface-partitions}
\input{sections/dust-displacement}
\input{sections/solar-eclipse}

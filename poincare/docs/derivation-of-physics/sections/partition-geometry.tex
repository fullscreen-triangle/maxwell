...
\caption{Categorical structure and partition geometry. \textbf{Top row:} Continuous-to-categorical mapping; completion order Hasse diagram; temporal emergence from completion; categorical irreversibility. \textbf{Middle row:} Partition coordinate space $(n, l, m)$; shell capacity $2n^2$; energy ordering $(n + l)$ rule; selection rules $\Delta l = \pm 1$. \textbf{Bottom row:} Spherical harmonic $Y_2^0$; angular momentum states for $l = 0, 1, 2$; chirality $s = \pm 1/2$ (spin); state degeneracy visualisation.}
